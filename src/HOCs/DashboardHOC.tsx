...
const renderData = (item: {
  ...
  <NavLink
    ...
    className={classNames(
      item.current
        ? " text-[#fafafa]"
        : "text-[#fafafa] hover:text-gray-300 hover:bg-[#1D263B]",
  ...
  >
    <item.icon
      className={classNames(
        item.current
          ? "text-[#fafafa]"
          : "text-[#fafafa] group-hover:text-gray-500",
    ...
    <>
      ...
      */}
      <div className="min-h-full">
        <Transition.Root show={sidebarOpen} as={Fragment}>
          ...
          >
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-[#141b2d] pt-5 pb-4">
                  <Transition.Child
                    as={Fragment}
        ...
        <div className="hidden lg:fixed bg-[#1f2a40] lg:inset-y-0 lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-gray-200 lg:bg-[bg-[#1f2a40]] lg:pt-5 lg:pb-4">
          <div className="flex flex-col bg-[#1f2a40] flex-shrink-0 items-center justify-center px-6">
            <img className="h-12 w-auto" src={Logo} alt="Your Company" />
            <h2 className="text-2xl font-bold">CARBON CORP</h2>
            <h4 className="text-[#4CCEAC]">EMISSION DATA</h4>
          </div>
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="mt-5 flex h-0 flex-1 bg-[#1f2a40]  flex-col overflow-y-auto pt-1">
        ...
        <div className="flex flex-col lg:pl-64">
          ...
          <main className="flex-1">
            ...
            <div className="mt-8 hidden sm:block px-5">{children}</div>
          </main>
        </div>
      </div>
    </>
